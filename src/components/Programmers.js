...
export default function Programmers() {
  const [listOfPro, setProgrammer] = useState(listOfAwesome)
  const [idOfPro, setId] = useState(null)
  ...
  return listOfPro[idOfPro - 1].name
  ...
  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: idOfPro ? 'green' : 'royalblue' // 🤔 color turns to gold, when celebrating
  };
